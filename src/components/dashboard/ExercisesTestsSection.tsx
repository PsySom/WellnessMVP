...
import { Clock, Search, ChevronRight, CalendarPlus, FileText, History } from 'lucide-react';
...
const ExercisesTestsSection = () => {
  ...
  const displayedItems = typeFilter === 'all' 
    ? [...filteredExercises.slice(0, 3), ...filteredTests.slice(0, 3)]
    : typeFilter === 'exercises'
    ? filteredExercises.slice(0, 6)
    : filteredTests.slice(0, 6);
    ...
    <Card className="animate-fade-in">
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-2xl">{t('dashboard.exercisesTests')}</CardTitle>
...
export default ExercisesTestsSection;
